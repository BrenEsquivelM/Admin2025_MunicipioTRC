...
// Rutas
app.use('/usuarios', checkToken, require('./routes/usuarios'));
...
app.get('/login/:username/:password', async (req, res) => {
    ...
    try {
        ...
        if (valid) {
            ...
            return res.cookie('token', token, { maxAge: 900000, secure: false, httpOnly: true, sameSite: 'Lax' }).json({ correcto: true, msg: 'Login correcto' });
        } else {
